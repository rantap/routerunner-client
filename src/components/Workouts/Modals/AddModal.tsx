  ...
  return (
    <DialogTrigger>
      <Button
        ...
        className='mt-6 flex rounded-full bg-violet-800 px-8 py-3 text-slate-50 shadow-md outline-none hover:bg-violet-900 data-[pressed]:scale-95 data-[focus-visible]:ring data-[focus-visible]:ring-orange-300 dark:bg-green-300 dark:text-zinc-900 dark:hover:bg-green-400 dark:hover:text-zinc-900 lg:mt-0'
      >
